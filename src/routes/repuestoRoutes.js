...
router.get(
  "/bajo-stock",
  auth,
  repuestoController.obtenerBajoStock
);
...
router.post(
  "/importar-stock",
  auth,
  repuestoController.importarStock
);
...
router.put(
  "/:id",
  auth,
  repuestoController.actualizarRepuesto
);
...
router.delete(
  "/:id",
  auth,
  repuestoController.eliminarRepuesto
);
...
router.patch(
  "/:id/stock",
  auth,
  repuestoController.ajustarStock
);
